...
t = {
    ...
    function ()
        ...
        love.graphics.rectangle('fill', 323, 20 * 5 + 10, 165, 2)
    end,
    function ()
        love.graphics.setFont(pygamefont)
    ...
    function ()
        ...
        local direction_queue = {'right', 'down'}

        for directionIndex, direction in ipairs(direction_queue) do
            love.graphics.setColor(255, 255, 255)
            love.graphics.print('direction_queue['..directionIndex..']: '..direction, 15, 15 * directionIndex)
        end
    end,
    function ()
        love.graphics.setFont(pygamefont)
