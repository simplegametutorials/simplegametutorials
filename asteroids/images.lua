...
local function drawShip(shipX, shipY, shipAngle)
...
},bulletTimer=0.48400967049838073,shipSpeedY=-38.649422672932722,shipX=329.63758865193228,shipSpeedX=41.030924422085342,shipAngle=5.8910186366852457,shipY=258.20777966622228}

local function drawGame(state)
    love.graphics.setColor(0, 0, 1)
    love.graphics.circle('fill', state.shipX, state.shipY, shipRadius)
    love.graphics.setColor(0, 1, 1)
    love.graphics.circle('fill', state.shipX + math.cos(state.shipAngle) * 20, state.shipY + math.sin(state.shipAngle) * 20, 5)
...
t = {
    ...
    function ()
        ...
        local state={asteroids={},bullets={},
            shipX=shipX,
            shipY=shipY,
            shipAngle=0.66086477996577742,
        }
        drawCanvas(function()
            drawGame(state)
        end)
        love.graphics.setColor(1, 1, 1)
        love.graphics.print('shipAngle: '..state.shipAngle)
    end,
    function ()
        drawBackground()
        local state={asteroids={},bullets={},
            shipX=shipX + 38.23875491101745,
            shipAngle=0.66086477996577742,
            shipY=shipY + 31.6100359214243,
            shipSpeedX=63.23140354795430,
            shipSpeedY=49.161879698613781,
        }
        drawCanvas(function()
            drawGame(state)
        end)
        ...
        love.graphics.print(table.concat({
            'shipAngle: '..state.shipAngle,
            'shipX: '..state.shipX,
            'shipY: '..state.shipY,
            'shipSpeedX: '..state.shipSpeedX,
            'shipSpeedY: '..state.shipSpeedY,
        }, '\n'))
    end,
    function ()
        drawBackground()
        local state={asteroids={},bullets={},
            shipX=shipX + 398.23875491101745,
            shipAngle=0.66086477996577742,
            shipY=shipY + 31.6100359214243,
            shipSpeedX=63.23140354795430,
            shipSpeedY=49.161879698613781,
    ...
    function ()
        ...
        state.bullets = {
            {
                x = state.shipX + math.cos(state.shipAngle) * shipRadius,
                y = state.shipY + math.sin(state.shipAngle) * shipRadius
            }
        }
        drawCanvas(function()
            drawGame(state)
